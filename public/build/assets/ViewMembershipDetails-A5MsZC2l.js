import{X as o,r as c,j as e}from"./app-DZ0vAk-i.js";import{A as m,a as l,b as p,c as h}from"./Footer-xv49gKwZ.js";import{h as n}from"./moment-C5S46NFB.js";import"./Helmet-Bf1uoCAg.js";const x=()=>{const{get_membership_by_id:t}=o().props,r=c.useRef(null),a=()=>{const d=r.current.innerHTML,s=document.createElement("iframe");s.style.position="absolute",s.style.width="0",s.style.height="0",s.style.border="none",document.body.appendChild(s);const i=s.contentDocument||s.contentWindow.document;i.open(),i.write(`
      <html>
        <head>
